...
[
  [
    ...
    [
      ...
      [
        "1.4 Quick Start: Try LambLisp on Windows",
        "index.html#quick-start-windows",
        [
          [
            "1.4.1 What you need",
          ...
          [
            "1.4.4 Running from any directory",
            "index.html#autotoc_md6",
            null
          ],
          [
            "1.4.5 What is the same as Linux, and what is not",
      ...
      [
        ...
        [
          [
            "1.6.1 Supported Platforms and Boards",
            "index.html#autotoc_md9",
            [
              [
                "1.6.1.1 ESP32 Hardware",
                "index.html#autotoc_md10",
                null
              ],
              [
                "1.6.1.2 Linux / Jetson Builds",
                "index.html#autotoc_md11",
                null
              ],
              [
                "1.6.1.3 CUDA Integration",
          ...
          [
            "1.6.2 Build and Flash",
            "index.html#autotoc_md12",
            null
          ],
          [
            "1.6.3 Connect to the REPL",
      ...
      [
        "1.7 What Happens at Startup",
        "index.html#autotoc_md14",
        null
      ],
      [
        "1.8 What's in the repository?",
  ...
  [
    ...
    [
      ...
      [
        "6.9 Arduino / Embedded I/O",
        "index.html#llarduino",
        [
          [
            "6.9.1 Where these run, and what actually drives a pin",
            "index.html#llarduino-backends",
            null
          ],
          [
            "6.9.2 Real pins on a Jetson or Raspberry Pi (libgpiod)",
            "index.html#llarduino-gpiod",
            null
          ]
        ]
      ],
  ...
  [
    ...
    [
      ...
      [
        ...
        "index.html#autotoc_md124",
        null
      ],
      [
        "8.3 Detailed Compatibility",
        "index.html#autotoc_md126",
        [
          [
            "8.3.1 Core Language",
