...
//!
//! P176.  This is what makes LLArduino a port rather than a simulation: `(digitalWrite 18 1)` in
...
//! B256.  If v2 support is wanted it goes beside this, not through it.
//! @{
...
//! I2C) -- and analogWrite needs a PWM chip wired to that specific pin.  P176's rule holds: a
