...
//!
//! P176.  This is the backend that runs where there is no GPIO to drive -- a developer laptop, an
...
//! failed USB port.  On 2026-09-04 exactly ONE of seven was reachable.  Anything that can only be
//! tested with a board in hand is, in practice, tested rarely; B256 (an Arduino 3.x WiFi
...
//! documented below rather than left to be discovered.  The rule from P176 -- never invent a
...
// ---------------------------------------------------------------------------
//! P176.  Until now the null backend WAS the implementation: pinMode() and friends were defined
